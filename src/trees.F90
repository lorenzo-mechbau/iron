...
999 ERRORSEXITS("TREE_DESTROY",ERR,ERROR)
  ...
  !>Detaches the tree values and returns them as a pointer to the array
...
998 ERRORSEXITS("TREE_DETACH",ERR,ERROR)
  ...
  !>Detaches the tree values and returns them as a pointer to the array and then destroys the tree
...
998 ERRORSEXITS("TREE_DETACH_AND_DESTROY",ERR,ERROR)
  ...
  !>Detaches the tree values in order from the specified tree node (e.g. root) and adds them to the tree values array
