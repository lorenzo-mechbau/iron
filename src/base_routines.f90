    ...
    IF(DIAG_FILE_OPEN.AND.ID==DIAGNOSTIC_OUTPUT_TYPE) THEN
      DO i=1,NUMBER_RECORDS
        IF(END_LINE(i)<=MAX_OUTPUT_WIDTH) THEN
          WRITE(DIAGNOSTICS_FILE_UNIT,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(1:END_LINE(i))
        ELSE IF(END_LINE(i)>MAX_OUTPUT_WIDTH.AND.END_LINE(i)<=MAXSTRLEN) THEN
          WRITE(DIAGNOSTICS_FILE_UNIT,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(1:MAX_OUTPUT_WIDTH)
          WRITE(DIAGNOSTICS_FILE_UNIT,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(MAX_OUTPUT_WIDTH+1:END_LINE(i))
        ELSE
          WRITE(DIAGNOSTICS_FILE_UNIT,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(1:MAX_OUTPUT_WIDTH)
          WRITE(DIAGNOSTICS_FILE_UNIT,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(MAX_OUTPUT_WIDTH+1:MAXSTRLEN)
        ENDIF
      ENDDO !i
    ELSE IF(TIMING_FILE_OPEN.AND.ID==TIMING_OUTPUT_TYPE) THEN
      DO i=1,NUMBER_RECORDS
        IF(END_LINE(i)<=MAX_OUTPUT_WIDTH) THEN
          WRITE(TIMING_FILE_UNIT,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(1:END_LINE(i))
        ELSE IF(END_LINE(i)>MAX_OUTPUT_WIDTH.AND.END_LINE(i)<=MAXSTRLEN) THEN
          WRITE(TIMING_FILE_UNIT,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(1:MAX_OUTPUT_WIDTH)
          WRITE(TIMING_FILE_UNIT,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(MAX_OUTPUT_WIDTH+1:END_LINE(i))
        ELSE
          WRITE(TIMING_FILE_UNIT,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(1:MAX_OUTPUT_WIDTH)
          WRITE(TIMING_FILE_UNIT,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(MAX_OUTPUT_WIDTH+1:MAXSTRLEN)
        ENDIF
      ENDDO !i
    ELSE
      IF(ID<=9) THEN !not file output
        DO i=1,NUMBER_RECORDS
          IF(END_LINE(i)<=MAX_OUTPUT_WIDTH) THEN
            WRITE(*,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(1:END_LINE(i))
          ELSE IF(END_LINE(i)>MAX_OUTPUT_WIDTH.AND.END_LINE(i)<=MAXSTRLEN) THEN
            WRITE(*,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(1:MAX_OUTPUT_WIDTH)
            WRITE(*,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(MAX_OUTPUT_WIDTH+1:END_LINE(i))
          ELSE
            WRITE(*,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(1:MAX_OUTPUT_WIDTH)
            WRITE(*,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(MAX_OUTPUT_WIDTH+1:MAXSTRLEN)
          ENDIF
        ENDDO !i
      ELSE !file output
        DO i=1,NUMBER_RECORDS
          WRITE(ID,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(1:END_LINE(i))
        ENDDO !i
      ENDIF
      ...
      IF(ECHO_OUTPUT) THEN
        DO i=1,NUMBER_RECORDS
          ...
          ELSE IF(END_LINE(i)>MAX_OUTPUT_WIDTH.AND.END_LINE(i)<=MAXSTRLEN) THEN
            ...
            WRITE(ECHO_FILE_UNIT,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(MAX_OUTPUT_WIDTH+1:END_LINE(i))
          ELSE
            WRITE(ECHO_FILE_UNIT,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(1:MAX_OUTPUT_WIDTH)
            WRITE(ECHO_FILE_UNIT,'(I3,A,A)') MY_COMPUTATIONAL_NODE_NUMBER,": ",OP_STRING(i)(MAX_OUTPUT_WIDTH+1:MAXSTRLEN)
          ENDIF
        ENDDO !i
      ENDIF
    ENDIF
