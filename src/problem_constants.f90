...
!!TODO: We don't really have two problem types here? Maybe a different type with nonlinear boundary conditions???
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_GUDUNOV_MONODOMAIN_ELASTICITY_W_TITIN_SUBTYPE=143
  INTEGER(INTG), PARAMETER :: PROBLEM_GUDUNOV_MONODOMAIN_1D3D_ACTIVE_STRAIN_SUBTYPE=145
  INTEGER(INTG), PARAMETER :: PROBLEM_STRANG_MONODOMAIN_1D3D_ELASTICITY_SUBTYPE=146
  INTEGER(INTG), PARAMETER :: PROBLEM_STRANG_MONODOMAIN_ELASTICITY_W_TITIN_SUBTYPE=147
  INTEGER(INTG), PARAMETER :: PROBLEM_STRANG_MONODOMAIN_1D3D_ACTIVE_STRAIN_SUBTYPE=148
