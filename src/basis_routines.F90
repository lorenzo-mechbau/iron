...
#include "macros.h"
  ...
  INTEGER(INTG), PARAMETER :: BASIS_GAUSS_HERMITE_QUADRATURE=3 !<Gauss-Hermite quadrature  \see BASIS_ROUTINES_QuadratureTypes,BASIS_ROUTINES
  ...
  PUBLIC BASIS_GAUSS_LEGENDRE_QUADRATURE,BASIS_GAUSS_LAGUERRE_QUADRATURE,BASIS_GAUSS_HERMITE_QUADRATURE,&
...
!!TODO: \todo Sort this properly by having a create values cache.
        ...
        CASE(BASIS_GAUSS_HERMITE_QUADRATURE)
    ...
    IF(ASSOCIATED(BASIS)) THEN
      ...
      ELSE
        IF(ASSOCIATED(BASIS%QUADRATURE%BASIS)) THEN
          ...
          CASE(BASIS_GAUSS_HERMITE_QUADRATURE)
            BASIS%QUADRATURE%TYPE=BASIS_GAUSS_HERMITE_QUADRATURE
