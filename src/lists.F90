...
#include "macros.h"
  ...
  PUBLIC LIST_REMOVE_DUPLICATES, LIST_REMOVE_DUPLICATES_WITHOUT_SORTING

  PUBLIC List_RemoveDuplicates, List_RemoveDuplicatesWithoutSorting
        ...
        IF(LIST%DATA_TYPE==LIST_INTG_TYPE) THEN
          IF(LIST%DATA_DIMENSION==1) THEN
            IF(LIST%NUMBER_IN_LIST+SIZE(ITEMS)>LIST%SIZE) THEN
              ...
              LIST%SIZE=NEW_SIZE
            ENDIF
            LIST%LIST_INTG(LIST%NUMBER_IN_LIST+1:LIST%NUMBER_IN_LIST+SIZE(ITEMS))=ITEMS
        ...
        IF(LIST%DATA_TYPE==LIST_INTG_TYPE) THEN
          IF(LIST%DATA_DIMENSION==SIZE(ITEMS,1)) THEN
            IF(LIST%NUMBER_IN_LIST+SIZE(ITEMS,2)>LIST%SIZE) THEN
              ...
              LIST%SIZE=NEW_SIZE
            ENDIF
            LIST%LIST_INTG2(:,LIST%NUMBER_IN_LIST+1:LIST%NUMBER_IN_LIST+SIZE(ITEMS,2))=ITEMS
            LIST%NUMBER_IN_LIST=LIST%NUMBER_IN_LIST+SIZE(ITEMS)
          ELSE
            LOCAL_ERROR="Invalid data dimension. The supplied data dimension is "// &
        ...
        IF(LIST%DATA_TYPE==LIST_SP_TYPE) THEN
          IF(LIST%DATA_DIMENSION==1) THEN
            IF(LIST%NUMBER_IN_LIST+SIZE(ITEMS)>LIST%SIZE) THEN
              ...
              LIST%SIZE=NEW_SIZE
            ENDIF
            LIST%LIST_SP(LIST%NUMBER_IN_LIST+1:LIST%NUMBER_IN_LIST+SIZE(ITEMS))=ITEMS
            LIST%NUMBER_IN_LIST=LIST%NUMBER_IN_LIST+SIZE(ITEMS)
          ELSE
            LOCAL_ERROR="Invalid data dimension. The supplied data dimension is 1 and the list data dimension is "// &
              & TRIM(NumberToVString(LIST%DATA_DIMENSION,"*",ERR,ERROR))//"."
        ...
        IF(LIST%DATA_TYPE==LIST_SP_TYPE) THEN
          IF(LIST%DATA_DIMENSION==SIZE(ITEMS,1)) THEN
            IF(LIST%NUMBER_IN_LIST+SIZE(ITEMS,2)>LIST%SIZE) THEN
              ...
              LIST%SIZE=NEW_SIZE
            ENDIF
            LIST%LIST_SP2(:,LIST%NUMBER_IN_LIST+1:LIST%NUMBER_IN_LIST+SIZE(ITEMS,2))=ITEMS
            LIST%NUMBER_IN_LIST=LIST%NUMBER_IN_LIST+SIZE(ITEMS)
          ELSE
            LOCAL_ERROR="Invalid data dimension. The supplied data dimension is "// &
              & TRIM(NumberToVString(SIZE(ITEMS,1),"*",ERR,ERROR))//" and the list data dimension is "// &
        ...
        IF(LIST%DATA_TYPE==LIST_DP_TYPE) THEN
          IF(LIST%DATA_DIMENSION==1) THEN
            IF(LIST%NUMBER_IN_LIST+SIZE(ITEMS)>LIST%SIZE) THEN
              ...
              LIST%SIZE=NEW_SIZE
            ENDIF
            LIST%LIST_DP(LIST%NUMBER_IN_LIST+1:LIST%NUMBER_IN_LIST+SIZE(ITEMS))=ITEMS
            LIST%NUMBER_IN_LIST=LIST%NUMBER_IN_LIST+SIZE(ITEMS)
          ELSE
            LOCAL_ERROR="Invalid data dimension. The supplied data dimension is 1 and the list data dimension is "// &
              & TRIM(NumberToVString(LIST%DATA_DIMENSION,"*",ERR,ERROR))//"."
        ...
        IF(LIST%DATA_TYPE==LIST_DP_TYPE) THEN
          IF(LIST%DATA_DIMENSION==SIZE(ITEMS,1)) THEN
            IF(LIST%NUMBER_IN_LIST+SIZE(ITEMS,2)>LIST%SIZE) THEN
              ...
              LIST%SIZE=NEW_SIZE
            ENDIF
            LIST%LIST_DP2(:,LIST%NUMBER_IN_LIST+1:LIST%NUMBER_IN_LIST+SIZE(ITEMS,2))=ITEMS
            LIST%NUMBER_IN_LIST=LIST%NUMBER_IN_LIST+SIZE(ITEMS)
          ELSE
            LOCAL_ERROR="Invalid data dimension. The supplied data dimension is "// &
              & TRIM(NumberToVString(SIZE(ITEMS,1),"*",ERR,ERROR))//" and the list data dimension is "// &
